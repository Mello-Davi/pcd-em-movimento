      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          <div className={styles.infoColumn}>
            ...
            <a href="https://wa.me/5511999999999" target="_blank" rel="noreferrer" className={styles.whatsappBtn} aria-label="Falar pelo WhatsApp (abre em nova aba)">
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                <div className={styles.iconBox} aria-hidden="true"><Mail aria-hidden="true" size={20} className="text-brand-dark" /></div>
                <span>contato@pcdemmovimento.org.br</span>
              </div>
              <div className={styles.contactItem}>
                <div className={styles.iconBox} aria-hidden="true"><Phone aria-hidden="true" size={20} className="text-brand-dark" /></div>
                <span>(11) 99999-9999</span>
              </div>
              <div className={styles.contactItem}>
                <div className={styles.iconBox} aria-hidden="true"><MapPin aria-hidden="true" size={20} className="text-brand-dark" /></div>
